# Contributing to ml-highcharts-ng

ml-highcharts-ng welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-highcharts-ng, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with HighCharts, MarkLogic, and AngularJS.
...
* **ml-highcharts-ng Version** - is it a named version or from our master branch
...
#### Fork ml-highcharts-ng

Fork the project [on GitHub](https://github.com/ryanjdew/ml-highcharts-ng/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-highcharts-ng.git
$ cd ml-highcharts-ng
$ git remote add upstream git://github.com/ryanjdew/ml-highcharts-ng.git
```
...
Go to https://github.com/username/ml-highcharts-ng and select your feature branch. Click
...
[wiki]: https://github.com/ryanjdew/ml-highcharts-ng/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/ryanjdew/ml-highcharts-ng/issues
